<div class="box-body">
    ...
    <div class='form-group{{ $errors->has('name') ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('name', old('name', $category->name), ['class' => 'form-control', 'placeholder' => trans('category name')]) !!}
	    {!! $errors->first('name', '<span class="help-block">:message</span>') !!}
	</div>

	<div class='form-group{{ $errors->has('slug') ? ' has-error' : '' }}'>
	    {!! Form::label('slug', trans('reference')) !!}
	    {!! Form::text('slug', old('slug', $category->slug), ['class' => 'form-control', 'placeholder' => trans('reference')]) !!}
