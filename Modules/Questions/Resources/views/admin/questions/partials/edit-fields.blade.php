<div class="box-body">
    ...
    <div class='form-group{{ $errors->has('question') ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('question', old('question', $question->question), ['class' => 'form-control', 'placeholder' => trans('questions::questions.form.question')]) !!}
	...
	<div class='form-group{{ $errors->has('answer_1') ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('answer_1', old('answer_1', $question->answer_1), ['class' => 'form-control', 'placeholder' => trans('questions::questions.form.answer_1')]) !!}
	...
	<div class='form-group{{ $errors->has('answer_2') ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('answer_2', old('answer_2', $question->answer_2), ['class' => 'form-control', 'placeholder' => trans('questions::questions.form.answer_2')]) !!}
	...
	<div class='form-group{{ $errors->has('answer_3') ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('answer_3', old('answer_3', $question->answer_3), ['class' => 'form-control', 'placeholder' => trans('questions::questions.form.answer_3')]) !!}
	...
	<div class='form-group{{ $errors->has('answer_4') ? ' has-error' : '' }}'>
	    ...
	    {!! Form::text('answer_4', old('answer_4', $question->answer_4), ['class' => 'form-control', 'placeholder' => trans('questions::questions.form.answer_4')]) !!}
